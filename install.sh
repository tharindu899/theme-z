...
nala install zsh python wget gh python-pip lazygit luarocks luajit ripgrep fd gettext neovim nodejs git micro openssh zip curl ruby timewarrior taskwarrior htop figlet termux-api logo-ls lsd -y || error_exit "${RED}Failed to install packages.${NC}"
